...
module.exports = function (homebridge) {
	...
	WinkDoorbellAcessory = require('./accessories/doorbells')(WinkAccessory, Accessory, Service, Characteristic, uuid);
				...
				wink.user().devices(function (devices) {
					for (var i = 0; i < devices.data.length; i++) {
						...
						if (device.light_bulb_id !== undefined)
							...
							that.log("Device Ignored Not In HomeKit - Group doorbells, ID " + device.door_bell_id + ", Name " + device.name);
